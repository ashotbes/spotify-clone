      ...
      <button
        ...
        <div class="flex items-center">
          <img class="rounded-full"
               width="27"
               src="https://yt3.ggpht.com/yti/ANjgQV8ZMZ_Eh0fB5rtkmewDFphbBnb2StbjcaMI45QnyAl2Mxo=s88-c-k-c0x00ffffff-no-rj"
          />
          <div class="text-white text-[14px] ml-1.5 font-semibold">Ashot Dev</div>
    ...
    <div class="h-[100%] p-6 w-[240px] fixed z-50 bg-black" id="SideNav">
      ...
      <ul>
        ...
        <RouterLink to="/library">
          <MenuItem class="ml-[2px]" :iconSize="23" name="Library" iconString="library" pageUrl="/search"/>
        </RouterLink>
